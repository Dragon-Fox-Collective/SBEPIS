...
namespace SBEPIS.Capturllection
{
	public class DequeRulesetLayer : DequeRuleset<DequeRulesetLayerState>
	{
		...
		public override Task<int> GetIndexToStoreInto(List<Storable> inventory, DequeRulesetLayerState state) => rulesets[^1].GetIndexToStoreInto(inventory, state.states[^1]);
