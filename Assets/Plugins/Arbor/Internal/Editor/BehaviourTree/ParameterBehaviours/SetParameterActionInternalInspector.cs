...
namespace ArborEditor.ParameterBehaviours
{
	...
	[CustomEditor(typeof(SetParameterActionInternal), true)]
	internal sealed class SetParameterActionInternalInspector : NodeBehaviourEditor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			{
				bool isCurrentInternalGraph = IsInGraphParameter(_ParameterReferenceProperty);
				if (!isInGraphParameter && isCurrentInternalGraph)
				{
				...
				else if (isInGraphParameter && !isCurrentInternalGraph)
				{
