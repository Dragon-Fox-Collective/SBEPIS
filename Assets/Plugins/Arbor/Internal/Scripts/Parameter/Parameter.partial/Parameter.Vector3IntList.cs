...
namespace Arbor
{
	public sealed partial class Parameter
	{
		...
		/// </summary>
#endif
		public IList<Vector3Int> vector3IntListValue
		{
			get
			{
				IList<Vector3Int> value;
				if (TryGetVector3IntList(out value))
				{
					return value;
				}
...
#endif
		public bool SetVector3IntList(IList<Vector3Int> value)
		{
			if (type == Type.Vector3IntList)
			{
				if (container._Vector3IntListParameters[_ParameterIndex].SetList(value))
				{
					DoChanged();
				}
				return true;
		...
		public bool TryGetVector3IntList(out IList<Vector3Int> value)
		{
			if (type == Type.Vector3IntList)
			{
				value = container._Vector3IntListParameters[_ParameterIndex].list;
...
#endif
		public IList<Vector3Int> GetVector3IntList()
		{
			IList<Vector3Int> value;
			if (TryGetVector3IntList(out value))
			{
