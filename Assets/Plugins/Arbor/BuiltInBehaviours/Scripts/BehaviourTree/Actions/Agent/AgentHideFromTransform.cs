...
namespace Arbor.BehaviourTree.Actions
{
	...
	public sealed class AgentHideFromTransform : AgentMoveBase
	{
		...
		{
			return agentController.Hide(_Speed.value, _TargetTransform.value, _MinDistanceToTarget.value, _ObstacleTargetFlags.value, _ObstacleSearchFlags.value, _ObstacleLayer.value);
		}
	}
}