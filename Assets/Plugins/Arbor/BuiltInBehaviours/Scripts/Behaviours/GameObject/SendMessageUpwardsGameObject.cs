...
namespace Arbor.StateMachine.StateBehaviours
{
	...
	[BuiltInBehaviour]
	public sealed class SendMessageUpwardsGameObject : StateBehaviour, INodeBehaviourSerializationCallbackReceiver
	{
		#region enum
		...
		{
			_Argument.SendMessageUpwards(_Target.value, _MethodName.value, SendMessageOptions.DontRequireReceiver);
		}
