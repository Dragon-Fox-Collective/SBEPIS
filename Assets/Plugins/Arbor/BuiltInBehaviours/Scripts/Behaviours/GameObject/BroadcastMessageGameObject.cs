...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("GameObject/BroadcastMessageGameObject")]
	[BuiltInBehaviour]
	public sealed class BroadcastMessageGameObject : StateBehaviour, INodeBehaviourSerializationCallbackReceiver
	{
		#region enum
		...
		{
			_Argument.BroadcastMessage(_Target.value, _MethodName.value, SendMessageOptions.DontRequireReceiver);
		}
