...
namespace Arbor.StateMachine.StateBehaviours
{
	...
	public sealed class CalcParameter : StateBehaviour, INodeBehaviourSerializationCallbackReceiver
	{
		...
		void OnConstraintDestroy(Parameter.Type parameterType)
		{
		...
		void INodeBehaviourSerializationCallbackReceiver.OnAfterDeserialize()
		{
			...
			{
				_ParameterReferenceConstrainter = new ParameterReferenceConstrainter(OnConstraintChangedType, OnConstraintDestroy);
			}
		...
		private void DoCalc(ExecuteMethodFlags executeMethodFlags)
		{
