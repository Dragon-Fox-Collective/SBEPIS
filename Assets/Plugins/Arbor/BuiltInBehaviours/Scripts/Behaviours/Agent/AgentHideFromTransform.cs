...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Agent/AgentHideFromTransform")]
	[BuiltInBehaviour]
	public sealed class AgentHideFromTransform : AgentMoveBase
	{
...
#else
		/// <summary>
		/// Transform of the object you want to hide
		/// </summary>
#endif
		...
		{
			return agentController.Hide(_Speed.value, _Target.value, _MinDistanceToTarget.value, _ObstacleTargetFlags.value, _ObstacleSearchFlags.value, _ObstacleLayer.value);
		}
	}
}
