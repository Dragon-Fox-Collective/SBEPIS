...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/SetRendererTexture")]
	[BuiltInBehaviour]
	public class SetRendererTexture : StateBehaviour
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
...
#endif
		[SerializeField] 
		[SlotType(typeof(Texture))]
		private FlexibleAssetObject _Texture = new FlexibleAssetObject();
		...
		public override void OnStateBegin()
		{
			...
			if (renderer != null)
			{
				...
				block.Update();
				block.SetTexture(_PropertyName.value, _Texture.value as Texture);
				block.Apply();
			}
		}
	}
