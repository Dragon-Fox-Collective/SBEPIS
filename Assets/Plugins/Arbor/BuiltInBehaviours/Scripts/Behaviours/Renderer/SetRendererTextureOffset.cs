...
#if ARBOR_DOC_JA
	/// <summary>
	/// Rendererのテクスチャオフセットを設定する。
	/// </summary>
	/// <remarks>設定にはMaterialPropertyBlockが使用される。</remarks>
#else
	/// <summary>
	/// Set the Renderer texture offset.
	/// </summary>
	/// <remarks>MaterialPropertyBlock is used for setting.</remarks>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/SetRendererTextureOffset")]
	[BuiltInBehaviour]
	public class SetRendererTextureOffset : StateBehaviour
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
		...
		public override void OnStateBegin()
		{
			...
			if (renderer != null)
			{
				...
				block.SetTextureOffset(propertyID, _Offset.value);
