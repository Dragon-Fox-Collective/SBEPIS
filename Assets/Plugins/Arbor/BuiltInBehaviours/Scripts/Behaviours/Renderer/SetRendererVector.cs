...
#else
	/// <summary>
	/// Set the Renderer vector.
	/// </summary>
	/// <remarks>MaterialPropertyBlock is used for setting.</remarks>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/SetRendererVector")]
	[BuiltInBehaviour]
	public class SetRendererVector : StateBehaviour
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
...
#endif
		[SerializeField] 
		private FlexibleVector4 _Value = new FlexibleVector4();
		...
		public override void OnStateBegin()
		{
			...
			if (renderer != null)
			{
				...
				block.Update();
				block.SetVector(_PropertyName.value, _Value.value);
				block.Apply();
			}
		}
	}
