...
#if ARBOR_DOC_JA
	/// <summary>
	/// RectIntをフォーマットした文字列を返す。
	/// </summary>
#else
	/// <summary>
	/// Returns a formatted string of RectInt.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("RectInt/RectInt.ToString")]
	[BehaviourTitle("RectInt.ToString")]
	[BuiltInBehaviour]
	public sealed class RectIntToStringCalculator : Calculator
	{
