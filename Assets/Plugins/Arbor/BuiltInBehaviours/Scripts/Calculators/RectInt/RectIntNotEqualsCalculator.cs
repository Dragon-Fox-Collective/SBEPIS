...
#if ARBOR_DOC_JA
	/// <summary>
	/// 2つのRectIntが等しくない場合にtrueを返す。
	/// </summary>
#else
	/// <summary>
	/// Returns true if the rectangles are not the same.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("RectInt/RectInt.NotEquals")]
	[BehaviourTitle("RectInt.NotEquals")]
	[BuiltInBehaviour]
	public sealed class RectIntNotEqualsCalculator : Calculator
	{
