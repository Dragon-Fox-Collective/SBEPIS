...
#if ARBOR_DOC_JA
	/// <summary>
	/// Rendererのテクスチャスケールを取得する
	/// </summary>
	/// <remarks>取得にはMaterialPropertyBlockが使用される。</remarks>
#else
	/// <summary>
	/// Get the Renderer texture scale
	/// </summary>
	/// <remarks>MaterialPropertyBlock is used for get.</remarks>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/GetRendererTextureScale")]
	[BuiltInBehaviour]
	public sealed class GetRendererTextureScale : Calculator
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
		...
		public override void OnCalculate()
		{
			...
			if (renderer != null)
			{
				...
				var value = block.GetTextureScale(propertyID);
