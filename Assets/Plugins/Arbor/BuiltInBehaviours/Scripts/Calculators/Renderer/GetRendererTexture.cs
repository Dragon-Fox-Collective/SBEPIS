...
#else
	/// <summary>
	/// Get the Renderer texture
	/// </summary>
	/// <remarks>MaterialPropertyBlock is used for get.</remarks>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/GetRendererTexture")]
	[BuiltInBehaviour]
	public sealed class GetRendererTexture : Calculator
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
		...
		public override void OnCalculate()
		{
			...
			if (renderer != null)
			{
				...
				var value = block.GetTexture(propertyID);
