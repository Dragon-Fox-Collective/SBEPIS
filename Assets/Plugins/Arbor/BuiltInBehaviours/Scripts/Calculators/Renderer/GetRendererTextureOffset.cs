...
#if ARBOR_DOC_JA
	/// <summary>
	/// Rendererのテクスチャオフセットを取得する
	/// </summary>
	/// <remarks>取得にはMaterialPropertyBlockが使用される。</remarks>
#else
	/// <summary>
	/// Get the Renderer texture offset
	/// </summary>
	/// <remarks>MaterialPropertyBlock is used for get.</remarks>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/GetRendererTextureOffset")]
	[BuiltInBehaviour]
	public sealed class GetRendererTextureOffset : Calculator
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
		...
		public override void OnCalculate()
		{
			...
			if (renderer != null)
			{
				...
				var value = block.GetTextureOffset(propertyID);
