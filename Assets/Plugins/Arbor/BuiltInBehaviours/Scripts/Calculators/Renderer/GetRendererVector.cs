...
#else
	/// <summary>
	/// Get the Renderer vector
	/// </summary>
	/// <remarks>MaterialPropertyBlock is used for get.</remarks>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Renderer/GetRendererVector")]
	[BuiltInBehaviour]
	public sealed class GetRendererVector : Calculator
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// 対象となるRenderer。
...
#endif
		[SerializeField]
		private OutputSlotVector4 _Output = new OutputSlotVector4();
		...
		public override void OnCalculate()
		{
			...
			if (renderer != null)
			{
				...
				var value = block.GetVector(propertyID);
