...
#else
	/// <summary>
	/// Returns a formatted string of Rect.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Rect/Rect.ToString")]
	[BehaviourTitle("Rect.ToString")]
	[BuiltInBehaviour]
	public sealed class RectToStringCalculator : Calculator
	{
