...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector2Int/Vector2Int.Max")]
	[BehaviourTitle("Vector2Int.Max")]
	[BuiltInBehaviour]
	public sealed class Vector2IntMaxCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Vector2Int.Max(_Lhs.value, _Rhs.value));
		}
	}
}