...
#if ARBOR_DOC_JA
	/// <summary>
	/// Vector4をフォーマットした文字列を返す。
	/// </summary>
#else
	/// <summary>
	/// Returns a formatted string of Vector4.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector4/Vector4.ToString")]
	[BehaviourTitle("Vector4.ToString")]
	[BuiltInBehaviour]
	public sealed class Vector4ToStringCalculator : Calculator
	{
