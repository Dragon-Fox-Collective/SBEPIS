...
#if ARBOR_DOC_JA
	/// <summary>
	/// Floatをフォーマットした文字列を返す。
	/// </summary>
#else
	/// <summary>
	/// Returns a formatted string of Float.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Float/Float.ToString")]
	[BehaviourTitle("Float.ToString")]
	[BuiltInBehaviour]
	public sealed class FloatToStringCalculator : Calculator
	{
		...
		/// Float
		/// </summary>
		[SerializeField] private FlexibleFloat _Float = new FlexibleFloat();
