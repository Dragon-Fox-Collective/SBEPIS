...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector3/Vector3.Lerp")]
	[BehaviourTitle("Vector3.Lerp")]
	[BuiltInBehaviour]
	public sealed class Vector3LerpCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Vector3.Lerp(_From.value, _To.value, _T.value));
		}
	}
}
