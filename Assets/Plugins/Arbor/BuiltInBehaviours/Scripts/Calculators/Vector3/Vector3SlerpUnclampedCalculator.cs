...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector3/Vector3.SlerpUnclamped")]
	[BehaviourTitle("Vector3.SlerpUnclamped")]
	[BuiltInBehaviour]
	public sealed class Vector3SlerpUnclampedCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Vector3.SlerpUnclamped(_From.value, _To.value, _T.value));
		}
	}
}
