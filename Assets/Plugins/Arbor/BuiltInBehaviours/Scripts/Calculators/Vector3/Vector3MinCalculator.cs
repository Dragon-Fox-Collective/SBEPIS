...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector3/Vector3.Min")]
	[BehaviourTitle("Vector3.Min")]
	[BuiltInBehaviour]
	public sealed class Vector3MinCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Vector3.Min(_Lhs.value, _Rhs.value));
		}
	}
}
