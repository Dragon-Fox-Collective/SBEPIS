...
#else
	/// <summary>
	/// Returns a formatted string of Bounds.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Bounds/Bounds.ToString")]
	[BehaviourTitle("Bounds.ToString")]
	[BuiltInBehaviour]
	public sealed class BoundsToStringCalculator : Calculator
	{
