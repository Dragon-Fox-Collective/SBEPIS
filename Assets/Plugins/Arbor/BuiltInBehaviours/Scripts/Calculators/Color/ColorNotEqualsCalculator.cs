...
#if ARBOR_DOC_JA
	/// <summary>
	/// 2つのColorがほぼ等しくない場合にtrueを返す。
	/// </summary>
#else
	/// <summary>
	/// Returns true if two Color are not approximately equal.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Color/Color.NotEquals")]
	[BehaviourTitle("Color.NotEquals")]
	[BuiltInBehaviour]
	public sealed class ColorNotEqualsCalculator : Calculator
	{
