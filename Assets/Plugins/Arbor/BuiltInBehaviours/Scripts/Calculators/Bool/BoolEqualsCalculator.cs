...
#if ARBOR_DOC_JA
	/// <summary>
	/// 2つのBoolが等しい場合にtrueを返す。
	/// </summary>
#else
	/// <summary>
	/// Returns true if the Bool are the same.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Bool/Bool.Equals")]
	[BehaviourTitle("Bool.Equals")]
	[BuiltInBehaviour]
	public sealed class BoolEqualsCalculator : Calculator
	{
