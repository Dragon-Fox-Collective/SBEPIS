...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("BoundsInt/BoundsInt.SetZMax")]
	[BehaviourTitle("BoundsInt.SetZMax")]
	[BuiltInBehaviour]
	public sealed class BoundsIntSetZMaxCalculator : Calculator
	{
