...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Quaternion/Quaternion.SlerpUnclamped")]
	[BehaviourTitle("Quaternion.SlerpUnclamped")]
	[BuiltInBehaviour]
	public sealed class QuaternionSlerpUnclampedCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Quaternion.SlerpUnclamped(_From.value, _To.value, _T.value));
		}
	}
}
