...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Quaternion/Quaternion.NotEquals")]
	[BehaviourTitle("Quaternion.NotEquals")]
	[BuiltInBehaviour]
	public sealed class QuaternionNotEqualsCalculator : Calculator
	{
