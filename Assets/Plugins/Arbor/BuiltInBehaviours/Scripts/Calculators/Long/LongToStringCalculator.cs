...
#else
	/// <summary>
	/// Returns a formatted string of Long.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Long/Long.ToString")]
	[BehaviourTitle("Long.ToString")]
	[BuiltInBehaviour]
	public sealed class LongToStringCalculator : Calculator
	{
		...
		/// Long
		/// </summary>
		[SerializeField] private FlexibleLong _Long = new FlexibleLong();
