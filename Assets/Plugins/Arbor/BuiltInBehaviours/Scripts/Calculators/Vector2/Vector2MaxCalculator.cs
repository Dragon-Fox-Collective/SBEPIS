...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector2/Vector2.Max")]
	[BehaviourTitle("Vector2.Max")]
	[BuiltInBehaviour]
	public sealed class Vector2MaxCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Vector2.Max(_Lhs.value, _Rhs.value));
		}
	}
}
