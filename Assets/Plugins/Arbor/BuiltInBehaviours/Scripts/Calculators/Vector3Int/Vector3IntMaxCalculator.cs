...
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Vector3Int/Vector3Int.Max")]
	[BehaviourTitle("Vector3Int.Max")]
	[BuiltInBehaviour]
	public sealed class Vector3IntMaxCalculator : Calculator
	{
		...
		{
			_Result.SetValue(Vector3Int.Max(_Lhs.value, _Rhs.value));
		}
	}
}