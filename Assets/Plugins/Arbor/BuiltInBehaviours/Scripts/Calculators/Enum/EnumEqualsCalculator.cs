...
#if ARBOR_DOC_JA
	/// <summary>
	/// 2つのEnumが等しい場合にtrueを返す。
	/// </summary>
#else
	/// <summary>
	/// Returns true if two Enums are equal.
	/// </summary>
#endif
	[AddComponentMenu("")]
	[AddBehaviourMenu("Enum/Enum.Equals")]
	[BehaviourTitle("Enum.Equals")]
	[BuiltInBehaviour]
	public sealed class EnumEqualsCalculator : Calculator, INodeBehaviourSerializationCallbackReceiver
	{
#if ARBOR_DOC_JA
		/// <summary>
		/// Enum型
