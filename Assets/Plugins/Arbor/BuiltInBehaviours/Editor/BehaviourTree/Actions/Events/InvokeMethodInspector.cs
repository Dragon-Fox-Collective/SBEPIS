...
namespace ArborEditor.BehaviourTree.Actions
{
	...
	{
		private SerializedProperty _ExecuteTypeProperty;
		...
		private static class Defaults
		{
			...
			static Defaults()
			{
				...
				string[] eventNames = System.Enum.GetNames(typeof(InvokeMethod.ActionTriggerType));
		...
		void OnEnable()
		{
			_ExecuteTypeProperty = serializedObject.FindProperty("_ExecuteType");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(_ExecuteTypeProperty);
